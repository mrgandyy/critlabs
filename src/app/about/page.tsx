    ...
    <main className="container-site">
      ...
      <section className="relative overflow-hidden py-20 md:py-28">
        ...
        <div className="grid items-center gap-10 md:grid-cols-2">
          ...
          >
            <Image
              src="/about/lab-hero.jpg"
              alt="CRIT lab & product"
              fill
      ...
      <section className="py-12 md:py-16">
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-3">
          <Card icon={<Zap />} title="Clean Energy">
            Natural caffeine sources and supporting aminos for smooth lift—without the junk.
          </Card>
          <Card icon={<Target />} title="Dialed Focus">
            Formulations designed for clarity and reaction time when the round gets sweaty.
          </Card>
          <Card icon={<ShieldCheck />} title="Transparent Labels">
            Clear dosing, clear intent. No proprietary blends. You deserve to know what’s inside.
          </Card>
        </div>
      </section>
        ...
        <div className="grid gap-10 md:grid-cols-2">
          <motion.div variants={fade} initial="hidden" whileInView="show" viewport={{ once: true }}>
            ...
            <ul className="mt-6 space-y-3 text-sm">
              ...
              <li className="flex items-start gap-2"><Trophy className="mt-0.5 h-4 w-4 text-mint"/> Built with creators & competitive players</li>
            </ul>
          </motion.div>
      ...
      <section className="py-12 md:py-16">
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-2">
          ...
          <FAQ q="Is it third-party tested?" a="We use evidence-informed dosing and publish labels transparently; third-party testing is part of our roadmap." />
